...
exports.koboTransformerNfiMpcaMyko = void 0;
const KoboFormsId_1 = require("../../conf/KoboFormsId");
const KoboTransformer_1 = require("./KoboTransformer");
exports.koboTransformerNfiMpcaMyko = new KoboTransformer_1.KoboTransformer(KoboFormsId_1.koboFormsId.prod.fcrmMpcaMyko, {
    kits: {
    ...
    return ({
        ...
        totalCosts: {
            HKMV: Number((_m = _.totalCosts.HKMV) !== null && _m !== void 0 ? _m : 0),
            HKF: Number((_o = _.totalCosts.HKF) !== null && _o !== void 0 ? _o : 0),
            BLN: Number((_p = _.totalCosts.BLN) !== null && _p !== void 0 ? _p : 0),
            Allkits: Number((_q = _.totalCosts.Allkits) !== null && _q !== void 0 ? _q : 0),
        }
    });
});
//# sourceMappingURL=KoboTransformerNfiMpcaMyko.js.map