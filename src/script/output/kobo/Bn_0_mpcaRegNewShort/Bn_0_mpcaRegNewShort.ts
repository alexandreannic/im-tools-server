import {Bn_0_mpcaRegNewShortOptions} from './Bn_0_mpcaRegNewShortOptions'

type Opt<T extends keyof typeof Bn_0_mpcaRegNewShortOptions> = keyof (typeof Bn_0_mpcaRegNewShortOptions)[T]

// Form id: a5kgQdqZLLNTLSmC8DK7Eq
export interface Bn_0_mpcaRegNewShort {
  start: string,
  end: string,
  today: string,
  ...
  child_hhh: string,
  // [note] **Enter information about the demographics of the household**
  ...
  // [note] **60 and above years**
  group_hh_composition_header_above_60: string,
  // [note] ##### Female
  group_hh_composition_row_note: string,
  // [integer] <span style="display:none">row-Under 4 years</span>
  group_hh_composition_row_less_4: number | undefined,
  // [integer] <span style="display:none">row-5 to 17 years</span>
  group_hh_composition_row_5_to_17: number | undefined,
  // [integer] <span style="display:none">row-18 to 59 years</span>
  group_hh_composition_row_18_to_59: number | undefined,
  // [integer] <span style="display:none">row-60 and above years</span>
  group_hh_composition_row_above_60: number | undefined,
  // [note] ##### Male
  group_hh_composition_row_1_note: string,
  // [integer] <span style="display:none">row_1-Under 4 years</span>
  group_hh_composition_row_1_less_4: number | undefined,
  // [integer] <span style="display:none">row_1-5 to 17 years</span>
  group_hh_composition_row_1_5_to_17: number | undefined,
  // [integer] <span style="display:none">row_1-18 to 59 years</span>
  group_hh_composition_row_1_18_to_59: number | undefined,
  // [integer] <span style="display:none">row_1-60 and above years</span>
  ...
  // [note] You are eligible for cash assistance, we will now ask you some detailed questions about yourself.
  ...
  // [select_one] Do you have access to bank branches/ ATMs?
