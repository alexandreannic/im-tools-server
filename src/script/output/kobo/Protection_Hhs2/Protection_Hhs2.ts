import {Protection_Hhs2Options} from './Protection_Hhs2Options'
...
export interface Protection_Hhs2 {
  ...
  // [calculate] what_is_the_type_of_your_household_min
  what_is_the_type_of_your_household_min: string,
  // [calculate] what_is_the_type_of_your_household_max
  ...
  // [calculate] haveBoy
  haveBoy: string,
  // [calculate] haveOtherSex
  haveOtherSex: string,
  // [calculate] haveGirl
  haveGirl: string,
  // [calculate] haveAdultMale
  haveAdultMale: string,
  // [calculate] haveAdultFemale
  ...
  // [calculate] get_tag_if_is_displaced
