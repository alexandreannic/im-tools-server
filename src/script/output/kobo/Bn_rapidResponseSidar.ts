export namespace Bn_rapidResponseSidar {
  ...
  export interface T {
    ...
    // [integer] What is your age?
    age: number | undefined,
    // [select_one] What is your sex?
    sex: undefined | Option<'sex'>,
    // [select_one] Did you receive the kit(s)?
    you_receive_kit: undefined | Option<'you_receive_kit'>,
    // [note] If "I receive no kits" In instances of reporting that the center has not received the kits, the following must take place:   • Apologise to the individual you are speaking to and the absence of the promised kits   • Explain that you will follow up on the status of the distribution, and get back to them with information as soon as possible   • End the interview, and return to conduct the interview once the kits have been received
    you_receive_kit_no: string,
    // [select_multiple] If Yes  - What type of NFI kit you have received?
    you_receive_kit_yes: undefined | Option<'you_receive_kit_yes'>[],
    // [text] If other, please specify:
    specify: string | undefined,
    // [note] Kindly note that this interview is only intended for your feedback on the Family kit (including Kitchen kit) and/or the Hygiene kit
    selected_other: string,
    // [integer] How many people in your household were supported by the kit(s) including you?
    family_supported_kit: number | undefined,
    // [select_multiple] Does any person in your household, which also benefitted from the kit(s) , fall under any of these categories?
    family_categories: undefined | Option<'family_categories'>[],
    // [text] If "Other" Please specify:
    family_categories_other: string | undefined,
    // [select_one] Are you satisfied with the kit contents?
    satisfied_kit_contents: undefined | Option<'satisfied_kit_contents'>,
    // [text] If "neither satisfied not dissatisfied" or "somewhat dissatisfied" or "very dissatisfied", please explain why:
    satisfied_kit_contents_bad_hkf: string | undefined,
    // [select_one] Do you think the quantity given for each item in the Hygiene kit is enough to last for 3 months?
    you_quantity_given: undefined | Option<'complaint_response'>,
    // [text] If No, which items do you consider insufficient?
    you_quantity_given_no_hkf: string | undefined,
    // [select_one] Do you think the quality given for each item is sufficient?
    quantity_bwk_sufficient: undefined | Option<'complaint_response'>,
    // [text] If No, which items do you consider insufficient?
    quantity_bwk_sufficient_no: string | undefined,
    // [select_one] Did you consider selling the kit/part of the kit and use the money in another way? If you did, it is ok to say so now - it will help us adapt our activities.
    consider_selling_kit: undefined | Option<'consider_selling_kit'>,
    // [select_multiple] If answer is 'Yes, and I sold it' then - What did you use the money from the kit sale for (which was more useful for you)?
    consider_selling_kit_yes: undefined | Option<'consider_selling_kit_yes'>[],
    // [text] If "Other" Please specify:
    consider_selling_kit_yes_other: string | undefined,
    // [select_one] Is there a particular item(s) you would wish to have included in the kit(s)?
    particular_item_wish: undefined | Option<'complaint_response'>,
    // [text] If "Yes", please state which one
    particular_item_wish_yes: string | undefined,
    // [select_one] In your opinion, has the provided Hygiene Kit improved the hygiene conditions of your household?
    provided_assistance_family: undefined | Option<'complaint_response'>,
    // [text] Comment
    provided_assistance_family_comments: string | undefined,
    // [select_one] In your opinion, has the provided NFI Family kit and Kitchen kit improved living conditions in your family?
    provided_assistance_nfkf: undefined | Option<'complaint_response'>,
    // [text] Comment
    provided_assistance_nfkf_comments: string | undefined,
    // [select_one] How did you receive the kit(s)?
    receive_kit: undefined | Option<'receive_kit'>,
    // [select_one] How easy or difficult for you was it to get to the distribution site?
    ...
    // [select_one] Overall, how would you evaluate the process of assistance delivery and distribution of the kit(s)?
    process_assistance_delivery: undefined | Option<'process_assistance_delivery'>,
    // [text] If "Very Bad"or "Bad" or "Satisfactory" , Please explain further
    process_assistance_delivery_bad: string | undefined,
    // [select_one] Were you requested anything in return for the assistance provided, apart from documentation?
    requested_return_assistance: undefined | Option<'complaint_response'>,
    // [text] If "Yes", please clarify
    requested_return_assistance_yes: string | undefined,
    // [note] #### 🔘 Please ensure to remind the individual that they can apply to the Code of Conduct Line. Remind them of the number if they did not receive the CFM leaflet, or they are not aware or the CFM line.
    not_remind_line: string,
    // [select_one] Did you feel you were treated with respect by the staff during the process?
    treated_respect_staff: undefined | Option<'complaint_response'>,
    // [text] If "No", Please explain further
    treated_respect_staff_no: string | undefined,
    // [select_one] Do you know how and where you could address your suggestions, comments or complaints related to the assistance, if any?
    know_your_suggestions: undefined | Option<'complaint_response'>,
    // [select_one] If "Yes", have you provided any feedback/ suggestions, complaints, or questions?
    know_your_suggestions_yes: undefined | Option<'know_your_suggestions_yes'>,
    // [select_one] If yes, have you received an answer or response?
    complaint_response: undefined | Option<'complaint_response'>,
    // [select_one] If "No did not provide any", why?
