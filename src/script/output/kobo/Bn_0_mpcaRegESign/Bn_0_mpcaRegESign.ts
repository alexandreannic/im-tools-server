import {Bn_0_mpcaRegESignOptions} from './Bn_0_mpcaRegESignOptions'

type Opt<T extends keyof typeof Bn_0_mpcaRegESignOptions> = keyof (typeof Bn_0_mpcaRegESignOptions)[T]

// Form id: a8JXohrBDqTdCc86Ysz26r
export interface Bn_0_mpcaRegESign {
  start: string,
  end: string,
  today: string,
