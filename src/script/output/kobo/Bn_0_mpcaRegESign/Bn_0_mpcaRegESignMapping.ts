import {Bn_0_mpcaRegESign} from './Bn_0_mpcaRegESign'
...
export const mapBn_0_mpcaRegESign = (_: Record<keyof Bn_0_mpcaRegESign, any>): Bn_0_mpcaRegESign => ({
	..._,
