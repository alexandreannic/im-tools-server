...
export interface Meal_CfmExternal {
  ...
  // [note] Зверніть увагу, що ви збираєтеся поділитися своїми особистими контактними даними з DRC, щоб команда могла відповісти на ваш відгук.     Якщо ви хочете залишитися анонімним і не бажаєте ділитися особистою інформацією, будь ласка, додайте "000000000" до свого номера телефону. Будь ласка, зверніть увагу, що якщо ви не надасте жодних контактних даних, ми можемо бути обмежені в нашій здатності відповісти вам.     Якщо ви бажаєте зв'язатися з нами напряму, ви можете зателефонувати на нашу гарячу лінію. #### 📞 0 800 33 95 18.
  consent: string,
