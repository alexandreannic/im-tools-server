...
//   }
//
//   readonly getOptionsFromEnumerated = async (e: FormDesc['schema']['elements'][0]) => {
//     return e.typeParameters.values
//   }
//
//   readonly getOptionsFromReference = async (e: FormDesc['schema']['elements'][0]): Promise<{
//     formId: AIID,
//     optionId: AIID,
//     labelsId: AIID,
//     options: any[]
...
//     const options = await Promise.all(forms.filter(_ => _.type === 'reference').map(f => this.getOptionsFromReference(f)))
